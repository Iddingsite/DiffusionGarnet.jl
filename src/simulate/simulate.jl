...
"""
function simulate(domain::Domain2DMajor; path_save=nothing, solver=ROCK2(), kwargs...)
...
"""
function simulate(domain::Domain3DMajor; path_save=nothing, solver=ROCK2(), kwargs...)
