...
"""
    simulate(domain::Domain1DMajor; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-4, p_extra = nothing, kwargs...)
...
"""
function simulate(domain::Domain1DMajor; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-4, p_extra = nothing, kwargs...)
...
"""
    simulate(domain::DomainSphericalMajor; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-4, p_extra = nothing, kwargs...)
...
"""
function simulate(domain::DomainSphericalMajor; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-4, p_extra=nothing, kwargs...)
...
"""
    simulate(domain::Domain2DMajor; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
function simulate(domain::Domain2DMajor; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
    simulate(domain::Domain3DMajor; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
function simulate(domain::Domain3DMajor; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
