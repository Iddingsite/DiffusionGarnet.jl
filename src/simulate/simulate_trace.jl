...
"""
    simulate(domain::Domain1DTrace; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-6, kwargs...)

Solve the linear diffusion equation in 1D. Save all timesteps in the output solution type variable by default.

"""
function simulate(domain::Domain1DTrace; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-6, p_extra = nothing, kwargs...)
...
"""
    simulate(domain::DomainSphericalTrace; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-6, p_extra=nothing, kwargs...)
...
"""
function simulate(domain::DomainSphericalTrace; path_save=nothing, solver=TSRKC3(), abstol=1e-8, reltol=1e-6, p_extra=nothing, kwargs...)
...
"""
    simulate(domain::Domain2DTrace; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
function simulate(domain::Domain2DTrace; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
    simulate(domain::Domain3DTrace; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
...
"""
function simulate(domain::Domain3DTrace; path_save=nothing, solver=TSRKC3(), p_extra = nothing, kwargs...)
