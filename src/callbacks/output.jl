function hdf5_initial_conditions(IC::InitialConditions1DMajor, Domain::Domain1DMajor, path_hdf5::String)
...
function hdf5_initial_conditions(IC::InitialConditions1DTrace, Domain::Domain1DTrace, path_hdf5::String)
    h5open(path_hdf5, "w") do file
        g = create_group(file, "Diffusion_Grt") # create a group
        ...
        # Create groups and set attributes for each group
        grp = create_group(t0, "C")
        attributes(grp)["DataType"] = "Scalar"
        attributes(grp)["Center"] = "Node"


        t0["C"]["C"] = convert(Array{Float32}, IC.C0)
    end
end

function hdf5_initial_conditions(IC::InitialConditionsSphericalMajor, Domain::DomainSphericalMajor, path_hdf5::String)
    h5open(path_hdf5, "w") do file
        g = create_group(file, "Diffusion_Grt") # create a group
...
function hdf5_initial_conditions(IC::InitialConditionsSphericalTrace, Domain::DomainSphericalTrace, path_hdf5::String)
    h5open(path_hdf5, "w") do file
        g = create_group(file, "Diffusion_Grt") # create a group
...
function hdf5_initial_conditions(IC::InitialConditions2DMajor, Domain::Domain2DMajor, path_hdf5)
...
function hdf5_initial_conditions(IC::InitialConditions2DTrace, Domain::Domain2DTrace, path_hdf5)
    ...
    h5open(path_hdf5, "w") do file
        ...
        # Create groups and set attributes for each group
        groups = ("C", "GrtPosition", "GrtBoundary")
        for group in groups
            grp = create_group(t0, group)
            attributes(grp)["DataType"] = "Scalar"
            attributes(grp)["Center"] = "Node"
...
function hdf5_initial_conditions(IC::InitialConditions3DMajor, Domain::Domain3DMajor, path_hdf5)
...
function hdf5_initial_conditions(IC::InitialConditions3DTrace, Domain::Domain3DTrace, path_hdf5)
...
function hdf5_timestep(u, dt, tcurrent, path_hdf5, IC::InitialConditionsMajor)
...
function hdf5_timestep(u, dt, tcurrent, path_hdf5, IC::InitialConditionsTrace)
    ...
    h5open(path_hdf5, "r+") do file
        ...
        # Create groups and set attributes for each group
        grp = create_group(t, "C")
        attributes(grp)["DataType"] = "Scalar"
        attributes(grp)["Center"] = "Node"

        t["C"]["C"] = convert(Array{Float32}, u)
    end
end
